...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(0, 416, 640, 21))
...
"padding: 5px 0;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Original"))
        self.pushButton_2.setText(_translate("MainWindow", "Median"))
        self.pushButton_3.setText(_translate("MainWindow", "Canny edge"))
        self.pushButton_4.setText(_translate("MainWindow", "Blur"))
        self.pushButton_5.setText(_translate("MainWindow", "Gaussian"))
        self.pushButton_6.setText(_translate("MainWindow", "Grayscale"))
        self.label.setText(_translate("MainWindow", "Filters"))
        self.label_2.setText(_translate("MainWindow", "Path"))
        self.label_3.setText(_translate("MainWindow", "Proyecto Final IMT-231"))
        self.pushButton_7.setText(_translate("MainWindow", "X"))
        self.label_4.setText(_translate("MainWindow", "Gabriela Zubieta"))
